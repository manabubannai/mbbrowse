...
final class BrowserWindowController: NSWindowController, NSWindowDelegate, WKNavigationDelegate, WKUIDelegate, NSTextFieldDelegate {
    ...
    func layout() {
        ...
        let tabH: CGFloat = 36, barH: CGFloat = 44
        ...
        urlField.frame = NSRect(x: 146, y: y + 3, width: b.width - 160, height: 26)
        webHost.frame = NSRect(x: 0, y: 0, width: b.width, height: b.height - tabH - barH)
    }
